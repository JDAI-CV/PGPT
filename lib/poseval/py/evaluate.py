...
def parseArgs():
    ...
    parser.add_argument("-g", "--groundTruth",required=False,default='/export/home/zby/SiamFC/data/posetrack/annotations_posetrack/val/',
                        type=str,help="Directory containing ground truth annotatations per sequence in json format")
    parser.add_argument("-p", "--predictions",required=False,default='/export/home/zby/SiamFC/data/test_result/',
